...
const Modal = ({ show, pizza, setShow }) => {
  ...
  return (
    <>
      {show && (
        <div
          className="fixed inset-0 bg-[rgba(0,0,0,0.3)] flex justify-center items-center overscroll-none overflow-hidden"
          style={{ zIndex: 2000 }}
        >
          <main className="min-w-[30rem] bg-white px-5 py-5 relative">
